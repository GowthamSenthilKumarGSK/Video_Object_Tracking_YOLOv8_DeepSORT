...
[`Github Repo Link`](https://github.com/GowthamSenthilKumarGSK/YOLOv8_Segmentation_DeepSORT_Object_Tracking.git)

## Steps to run Code

- Clone the repository
```
git clone https://github.com/GowthamSenthilKumarGSK/YOLOv8-DeepSORT-Object-Tracking.git
```
